<?php
/**
 * ListMessenger Session Information.
 */

// Setup PHP and start page setup.
ini_set('include_path', str_replace('\\', '/', dirname(__FILE__).'/../../../includes'));
ini_set('allow_url_fopen', 1);
ini_set('session.name', md5(str_replace(DIRECTORY_SEPARATOR.'javascript'.DIRECTORY_SEPARATOR.'filemanager'.DIRECTORY_SEPARATOR.'config', '', dirname(__FILE__))));
...
/**
 * Response Filemanager Configuration.
 */
$version = '9.14.0';

$default_charset = ((array_key_exists($_SESSION['config'][PREF_DEFAULT_CHARSET], $CHARACTER_SETS)) ? $_SESSION['config'][PREF_DEFAULT_CHARSET] : 'ISO-8859-1');
...
date_default_timezone_set($_SESSION['config'][PREF_TIMEZONE]);
...
$config = [
    ...
    |
    */
    'base_url' => rtrim($_SESSION['config'][PREF_PROGURL_ID], '/'),
    ...
    |
    */
    'upload_dir' => str_ireplace(rtrim($_SESSION['config'][PREF_PROGURL_ID], '/'), '', $_SESSION['config'][PREF_PUBLIC_URL]).'files/',
    /*
    |--------------------------------------------------------------------------
    ...
    */
    ...
    |
    */
    'thumbs_upload_dir' => '/public/images/',
    ...
    *******************/
    ...
    'hidden_files' => ['config.php', 'public_config.inc.php', 'config.inc.php'],
