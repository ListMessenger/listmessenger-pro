...
{   // initialize some vars
     ...
     **/
    public function property($p = null)
    {
        if ($p == null) {
     ...
     *	alias for property.
     **/
    public function get_property($p)
    {
     ...
     *  @private
     **/
    public function _perform_browser_search($data)
    {
        $search = [];
    ...
    public function _perform_language_search($data)
    ...
    public function _get_short_name($long_name = '')
    {
        if (!empty($this->_browsers[strtolower($long_name)])) {
    ...
    public function _get_javascript()
    {
        $set = false;
