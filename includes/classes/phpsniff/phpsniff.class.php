...
class phpSniff extends phpSniff_core
{
     ...
     *              :               set in the $_browsers array
     **/
    public $_temp_file_path = '/tmp/'; // with trailing slash
    ...
    public $_javascript_versions = [
        '1.5' => 'NS5+,MZ,PX,FF,GA,CH,CA,SF,KQ3+,KM', // browsers that support JavaScript 1.5
        '1.4' => '',
        '1.3' => 'NS4.05+,OP5+,IE5+',
        '1.2' => 'NS4+,IE4+',
        '1.1' => 'NS3+,OP,KQ',
    ...
    public $_browser_features = [
         ...
         **/
        'css2' => 'NS5+,IE5+,MZ,PX,FF,CH,CA,SF,GA,KQ3+,OP7+,KM',
        'css1' => 'NS4+,IE4+,MZ,PX,FF,CH,CA,SF,GA,KQ,OP7+,KM',
        'iframes' => 'IE3+,NS5+,MZ,PX,FF,CH,CA,SF,GA,KQ,OP7+,KM',
        'xml' => 'IE5+,NS5+,MZ,PX,FF,CH,CA,SF,GA,KQ,OP7+,KM',
        'dom' => 'IE5+,NS5+,MZ,PX,FF,CH,CA,SF,GA,KQ,OP7+,KM',
        'hdml' => '',
        'wml' => '',
        ];

    public $_browser_quirks = [
        'must_cache_forms' => 'NS,MZ,FF,PX',
    ...
    public function __construct($UA = '', $settings = true)
